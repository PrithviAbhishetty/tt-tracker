...
import { fetchLeaderboard } from "@/lib/offline/players-cache";
...
export function Leaderboard() {
  ...
  useEffect(() => {
    void fetchLeaderboard().then((s) =>
      setState({ players: s.players, matches: s.matches }),
    );
  }, []);
  ...
  return (
    <>
      ...
      >
        ...
        <Stat label="matches" value={state.matches} />
      ...
      {!champion ? (
        ...
        <>
          <div className="relative tt-pop" style={{ animationDelay: "160ms" }}>
            <Champion champion={champion} />
          </div>
          {rest.length > 0 && <Ranked list={rest} startIndex={2} />}
        </>
      )}
    </>
  );
    ...
    >
      ...
      <div className="flex items-end justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <div className="brush text-2xl sm:text-4xl text-ink mt-2 leading-tight line-clamp-2">
        ...
        <div className="text-right shrink-0">
          ...
          <div className="display text-4xl sm:text-7xl text-ink leading-none tnum mt-1">
